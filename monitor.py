...
# Get Survey Name
survey = s.get(SURVEDA_URL+'/api/v1/projects/'+args.project+'/surveys/'+args.survey)
survey_name = survey.json()['data']['name']

# Get Interactions
r = s.get(SURVEDA_URL+'/api/v1/projects/'+args.project+'/surveys/'+args.survey+'/respondents/interactions_csv')
